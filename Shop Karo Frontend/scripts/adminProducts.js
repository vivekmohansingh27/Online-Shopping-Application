...
function addProduct(){
  ...
  const productCategoryId = document.getElementById("validationCustom05").value;
    ...
    fetch(`http://localhost:8080/admin/products?sessionKey=${sessionid.uuid}`, requestOptions)
...
function updateProduct(){
  ...
  const productManufac = document.getElementById("update_product_manufac").value;
  const productQuantity= document.getElementById("update_product_quantity").value;
  const productCategory = document.getElementById("validationCustom04up").value;
  const productCategoryId = document.getElementById("validationCustom05id").value;
